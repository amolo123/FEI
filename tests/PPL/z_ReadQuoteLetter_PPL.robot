...
Resource                        ../../PageObjects/PPL/PageObjects_PDFRead_PPL.robot
...
*** Test Cases ***
Read Quote Letter Policy Document and Binder For PPL
    #Author = Amol Gaymukhe
    #TC=69052
    [Documentation]             Verify able Read Quote Letter Policy Document and Binder For PPL
    ...
    Read Doc Quote Letter Static Document PPL
    Read Doc Quote Letter Dynamic Document PPL
    Click On Bind
    Sleep                       30s
    Get Policy No
    ...
    Sleep                       20s
    Get WORD document and attach it to log
    Read Policy Letter Static Document PPL
    Read Policy Letter Dynamic Document PPL
    Back
    ...
    Sleep                       20s
    Get WORD document and attach it to log
    Read Binder Letter Static Document PPL
    Read Binder Letter Dynamic Document PPL
    Logout