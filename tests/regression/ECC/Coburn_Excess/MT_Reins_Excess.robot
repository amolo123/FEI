...
*** Test Cases ***
Excess Validate Billing Record for EXS_Midterm_Cancellation and Reinstatment 
    #Author = Akshay
    #TC=117093,117099
    [Documentation]             Excess Validate Billing Record for ECC_Midterm_Cancellation and Reinstatment
