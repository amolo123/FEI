...
*** Test Cases ***
PPL Validate Billing Record Tab
    #Author = Rugveda
    #TC=117065,117068,117083
    [Documentation]             PPL Validate Billing Record for New Business (NB) , Non Premium bearing Endosement and Premium bearing Endosement
    ...
    Validate Dynamic feilds on Billing Record               ${PolicyNumber_BR}          ${QuoteNameBill}            ${uniqueName}               ${broker_contact}    Freberg              CALIFORNIA INS CO          PPL
