...
*** Test Cases ***
STEIL Validate Billing Record for Midterm_Cancellation , Reinstatment and Renewal
    #Author = Akshay
    #TC=117072,117090,117081
    [Documentation]             STEIL Validate Billing Record for Midterm_Cancellation , Reinstatment and Renewal
    ...
    Open Billing Record         Midterm Cancellation
    Download Invoice
    Move to outputdir
    Verify Content on billing record PDF                    Midterm Cancellation        ${uniqueName}
    Empty Directory command
    Log To Console              ---- Reinstatement ---
    Navigate to policy Page from Billing record page
    Change Policy               Reinstatement
    Select Reinstatment Input
    Open Billing Record         Reinstatement
    Download Invoice
    Move to outputdir
    Verify Content on billing record PDF                    Reinstatement               ${uniqueName}
    Empty Directory command
    Log To Console              ---- Renewal ---
    Navigate to policy Page from Billing record page
    Click On renewal
