...
Resource                        ../../PageObjects/ECC/PageObjects_PDFRead_ECC.robot
...
Read Quote Letter Policy Document and Binder For ECC
    #Author = Amol Gaymukhe
    #TC=Reg-69004,Reg-77541,Reg-69003
    [Documentation]             Read ECC quote Letter Static and Dynamic data
    ...
    Read Doc Quote Letter Static Document ECC
    Read Doc Quote Letter Dynamic Document ECC
    Click On Bind
    Sleep                       30s
    Get Policy No
    ...
    Sleep                       20s
    Get WORD document and attach it to log
    Read Policy Letter Static Document ECC
    Read Policy Letter Dynamic Document ECC
    Back
    ...
    Sleep                       20s
    Get WORD document and attach it to log
    Read Binder Letter Static Document ECC
    Read Binder Letter Dynamic Document ECC
    Logout
