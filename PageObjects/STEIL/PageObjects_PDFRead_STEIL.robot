...
Read Binder Letter Static Document STEIL
    ...
    [Tags]             smoke
    #Log To Console     ${read_doc}
    Should Contain     ${read_doc}                 STEIL Binding Acknowledgment
    #Should Contain    ${read_doc}                 Outstanding Subjectivities
    Should Contain     ${read_doc}                 FOR PREMIUM FINANCED ACCOUNTS:
    Should Contain     ${read_doc}                 Coverage Part
    Should Contain     ${read_doc}                 Name
    Should Contain     ${read_doc}                 Form Of Business:
    Should Contain     ${read_doc}                 Named Insured and Address
    Should Contain     ${read_doc}                 Endorsements
