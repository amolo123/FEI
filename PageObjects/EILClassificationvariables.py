...
Wholesale = {
    ...
    'list': [
        ...
        "424710 - Petroleum Bulk Stations and Terminals - <150,000 Gallons",
        "424710 - Petroleum Bulk Stations and Terminals - 151,000 to 1M",
        "424710 - Petroleum Bulk Stations and Terminals - Over 1M",
...
Finance= {'Total': '4','list': ["521110 - Monetary Authorities - Central Bank","522110 - Commercial Banking","522120 - Savings Institutions","522130 - Credit Unions"]}
...
Professional = {'Total': '4','list':["541380 - Testing Laboratories","541921 - Photography Studios, Portrait","541922 - Commercial Photography","541940 - Veterinary Services"]}
...
Adminstrative = {
    ...
    'list': [
        ...
        "562212 - Municipal Solid Waste Landfill",
...
Educational= {'Total': '3','list':["611110 - Elementary and Secondary Schools","611210 - Junior Colleges","611310 - Colleges, Universities, and Professional Schools"]}
...
Public= {'Total': '3','list':["922140 - Correctional Institutions","922150 - Parole Offices and Probation Offices","922160 - Fire Protection"]}


Manufacturing = {'Total': '470', 'list': 
[
...
def get_variables(env):
    if env == 'Utilities':
        ...
        return Other
    elif env == 'Agriculture':
        return Agriculture
    elif env == 'Wholesale':
        return Wholesale  
    elif env == 'Retail':
        return Retail 
    elif env == 'Transportation':
        return Transportation  
    elif env == 'Information':
        return Information   
    elif env == 'Finance':
        return Finance 
    elif env == 'Real':
        return    Real  
    elif env == 'Professional':
        return Professional      
    elif env == 'Adminstrative':
        return    Adminstrative 
    elif env == 'Healthcare':
        return    Healthcare
    elif env == 'Arts':
        return    Arts 
    elif env == 'Accommodation':
        return    Accommodation
    elif env == 'Public':
        return    Public  
    elif env == 'Manufacturing':
